...
def scan(
    ...
    *,
    ...
    out_dir = Path(output_dir) if output_dir else target_path / "lensify-out"
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output", default=None,
                        help="Override output directory (default: <target>/lensify-out)")
    ...
    parser.add_argument("--version", action="version", version=f"lensify {VERSION}")
