"""CLI for /lensify stats command (Phase 8).
...
try:
    ...
    print("lensify stats unavailable (import failed)", file=sys.stderr)
    sys.exit(1)


def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="Lensify lifetime stats")
