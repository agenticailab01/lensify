...
Lensify chooses one of three tiers based on measured signals. The exact algorithm is in `scripts/complexity.py` — this file documents the *intent*.
...
- Linked sub-capsules: one per domain, written to `lensify-out/capsules/<domain>.md`
