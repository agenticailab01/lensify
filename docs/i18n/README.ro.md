...
> 🌐 **Română** — Înapoi la engleză: [English](../../README.md)
...
> **Lentilă de proiect adaptivă cu o singură scanare + capsulă de context optimizată pentru tokeni pentru agenții de codare AI.** Reduce tokenii de orientare cu 70–90%. Conștient de framework pe întreg ciclul de viață de dezvoltare AI. Bibliotecă standard pură. Licență MIT.

**📖 Citește în limba ta:** 🇬🇧 [← Înapoi la engleză](../../README.md) · 🇨🇳 [简体中文](README.zh-CN.md) · 🇹🇼 [繁體中文](README.zh-TW.md) · 🇯🇵 [日本語](README.ja.md) · 🇰🇷 [한국어](README.ko.md) · 🇩🇪 [Deutsch](README.de.md) · 🇫🇷 [Français](README.fr.md) · 🇪🇸 [Español](README.es.md) · 🇮🇳 [हिन्दी](README.hi.md) · 🇧🇷 [Português](README.pt.md) · 🇷🇺 [Русский](README.ru.md) · 🇸🇦 [العربية](README.ar.md) · 🇮🇹 [Italiano](README.it.md) · 🇵🇱 [Polski](README.pl.md) · 🇳🇱 [Nederlands](README.nl.md) · 🇹🇷 [Türkçe](README.tr.md) · 🇺🇦 [Українська](README.uk.md) · 🇻🇳 [Tiếng Việt](README.vi.md) · 🇮🇩 [Bahasa Indonesia](README.id.md) · 🇸🇪 [Svenska](README.sv.md) · 🇬🇷 [Ελληνικά](README.el.md) · 🇨🇿 [Čeština](README.cs.md) · 🇫🇮 [Suomi](README.fi.md) · 🇩🇰 [Dansk](README.da.md) · 🇳🇴 [Norsk](README.no.md) · 🇭🇺 [Magyar](README.hu.md) · 🇹🇭 [ภาษาไทย](README.th.md) · 🇺🇿 [O'zbekcha](README.uz.md)

---

## Cuprins

1. [De ce ProjectLens](#why-projectlens)
2. [Pe scurt](#at-a-glance)
3. [Pornire rapidă](#quick-start)
4. [Cum funcționează](#how-it-works)
5. [Instalare per unealtă (4 canale)](#installation-by-tool)
6. [Niveluri adaptive — T1 / T2 / T3](#adaptive-tiers)
7. [Acoperire framework — 30 de adaptoare în 8 pachete](#framework-coverage)
8. [Hook-uri de sesiune — 5 hook-uri de producție](#session-hooks)
9. [Compactor de conversație](#conversation-compactor)
10. [Economia token-urilor — cifre concrete](#token-economics)
11. [Teste și bugete de performanță](#tests--performance)
12. [Securitate și guvernanță](#security--governance)
13. [Variabile de mediu de configurare](#configuration)
14. [Structura proiectului](#project-structure)
15. [Extinde — scrie propriul adaptor](#extending-projectlens)
16. [Comparație cu alternative](#comparison)
17. [Întrebări frecvente](#faq)
18. [Foaie de parcurs](#roadmap)
19. [Contribuții și licență](#contributing--license)

---

## De ce ProjectLens

Agenții moderni de codare AI au o problemă de fereastră de context: cu cât proiectul este mai mare, cu atât mai multe tokeni ard doar pentru **a se orienta**. Un flux tipic de onboarding citește 20-40 de fișiere înainte ca agentul să poată face muncă utilă — sunt 10-30k tokeni cheltuiți pentru înțelegere, nu pentru rezolvarea problemei reale a utilizatorului.

ProjectLens înlocuiește acea fază de orientare cu **o singură scanare** (sub 100 ms) care produce un bloc de context limitat în tokeni, conștient de framework. Agentul citește **o capsulă** în loc de zeci de fișiere. Utilizarea tokenilor scade cu 70-90% doar din economiile de orientare.

**Compromisul:** extracție structurală deterministă (rapidă, gratuită, conștientă de framework) în loc de căutare vectorială semantică. ProjectLens lucrează alături de instrumentele semantice, nu împotriva lor.
...
📖 Instrucțiuni complete pas cu pas în **[`USER-INSTALL.md`](../../USER-INSTALL.md)**
---

## Cum funcționează

Motorul de scanare rulează cinci faze pe invocare:
...
Timp tipic de rulare: **30 ms** pe proiecte medii, **113 ms** pe un proiect cu 500 de fișiere.

**Două artefacte pe scanare:**
...
## Instalare per unealtă (4 canale)

Patru canale de distribuție împart același motor de scanare.

### Channel 1 — Claude Code / Cowork plugin (recommended)

Experiența completă: toate cele 5 hook-uri se declanșează, comenzi slash, statusline, memory loader.
...
Server JSON-RPC 2.0 stdio în stdlib pur. Nu este necesar pasul `pip install` pentru server — rulează direct din repo-ul clonat folosind doar biblioteca standard Python.
...
## Niveluri adaptive — T1 / T2 / T3

ProjectLens alege automat profunzimea corectă.
...
Indicii de suprascriere în chat:
...
## Acoperire framework — 30 de adaptoare în 8 pachete

30 de adaptoare în 8 pachete. Fiecare adaptor are ~80-120 LOC.
...
O singură scanare ProjectLens pe un proiect AI scoate la suprafață fiecare verigă din lanț.

---

## Hook-uri de sesiune — 5 hook-uri de producție

5 hook-uri se compun într-o sesiune Claude Code. Economiile de tokeni se acumulează.
...
**Limitare Cowork:** doar SessionStart se declanșează în suprafața hook a Cowork.

---

## Compactor de conversație

Sesiunile lungi consumă context. Compactorul recuperează 8-25k tokeni în secunde.
...
Compactorul citește starea sesiunii și generează un `WORKING_CONTEXT.md`:
...
Avertisment stare goală: dacă niciun hook PostToolUse nu s-a declanșat, compactorul emite o diagnoză clară.

---

## Economia token-urilor — cifre concrete

De unde vin economiile — numere concrete:
...
**Exemplu de cost (preț Opus, $15/Mtok input):** o sesiune de codare de 4 ore care costa ~$3 scade la ~$0,45–$0,90.

---

## Teste și bugete de performanță

**527 de teste unitare** + **17 bugete de performanță și securitate impuse de CI** rulează la fiecare commit.
...
**Nimic nu este trimis în afara dispozitivului** decât dacă rulați explicit `/projectlens compact --llm`.

For governance — what contributions we accept and what we don't — see [`GOVERNANCE.md`](../../GOVERNANCE.md).

---

## Variabile de mediu de configurare
...
## Extinde — scrie propriul adaptor
...
ProjectLens este **stratul ușor și determinist de orientare** în spațiul asistenților de codare AI.
...
R: Scanarea de bază funcționează pe JS, TS, Go, Java, Rust și ~20 alte limbi.
...
R: Nu, decât dacă rulați explicit `/projectlens compact --llm` ȘI aveți `ANTHROPIC_API_KEY` setat.
...
**Q: Is it free?**
R: Da — licență MIT. Fără abonament, fără telemetrie.
...
Votați cu issues GitHub — ce ar trebui să vină primul?
...
⭐ Marcați cu stea acest repo dacă ProjectLens vă economisește tokeni.
