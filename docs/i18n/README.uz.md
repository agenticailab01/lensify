...
1. [Nima uchun ProjectLens](#why-projectlens)
...
15. [Kengaytiring — o'z adapteringizni yozing](#extending-projectlens)
...
ProjectLens bu yo'naltirish bosqichini **bitta skanerlash** (100 ms dan kam) bilan almashtiradi, bu token bilan chegaralangan, framework xabardor kontekst bloki ishlab chiqaradi. Agent o'nlab fayllar o'rniga **bitta kapsula** o'qiydi. Token foydalanish faqat yo'naltirish tejamlaridan 70-90% kamayadi.

**Murosa:** semantik vektor qidiruvi o'rniga deterministik tizimli ekstraksiya. ProjectLens semantik vositalar bilan birga ishlaydi, ularga qarshi emas.
...
ProjectLens avtomatik ravishda to'g'ri chuqurlikni tanlaydi.
...
AI ishlab chiqish loyihasida bitta ProjectLens skanerlash zanjirning har bir bo'g'inini ochib beradi.
...
**`/projectlens compact --llm` ni aniq ishga tushirmasangiz, hech narsa qurilmadan tashqariga yuborilmaydi**.
...
ProjectLens — AI kodlash yordamchilari makonidagi **engil, deterministik yo'naltirish qatlami**.
...
J: Yo'q, agar siz `/projectlens compact --llm` ni aniq ishga tushirmasangiz VA `ANTHROPIC_API_KEY` o'rnatilgan bo'lmasa.
...
⭐ ProjectLens sizga token tejasa, bu repoga yulduzcha qo'ying.
