...
> 🌐 **Čeština** — Zpět na angličtinu: [English](../../README.md)
...
> **Adaptivní projektová čočka s jediným skenováním + tokenově optimalizovaná kontextová kapsle pro AI kódovací agenty.** Snižuje orientační tokeny o 70–90%. Vědomí frameworků v celém životním cyklu vývoje AI. Čistá standardní knihovna. Licence MIT.

**📖 Čtěte ve svém jazyce:** 🇬🇧 [← Zpět na angličtinu](../../README.md) · 🇨🇳 [简体中文](README.zh-CN.md) · 🇹🇼 [繁體中文](README.zh-TW.md) · 🇯🇵 [日本語](README.ja.md) · 🇰🇷 [한국어](README.ko.md) · 🇩🇪 [Deutsch](README.de.md) · 🇫🇷 [Français](README.fr.md) · 🇪🇸 [Español](README.es.md) · 🇮🇳 [हिन्दी](README.hi.md) · 🇧🇷 [Português](README.pt.md) · 🇷🇺 [Русский](README.ru.md) · 🇸🇦 [العربية](README.ar.md) · 🇮🇹 [Italiano](README.it.md) · 🇵🇱 [Polski](README.pl.md) · 🇳🇱 [Nederlands](README.nl.md) · 🇹🇷 [Türkçe](README.tr.md) · 🇺🇦 [Українська](README.uk.md) · 🇻🇳 [Tiếng Việt](README.vi.md) · 🇮🇩 [Bahasa Indonesia](README.id.md) · 🇸🇪 [Svenska](README.sv.md) · 🇬🇷 [Ελληνικά](README.el.md) · 🇷🇴 [Română](README.ro.md) · 🇫🇮 [Suomi](README.fi.md) · 🇩🇰 [Dansk](README.da.md) · 🇳🇴 [Norsk](README.no.md) · 🇭🇺 [Magyar](README.hu.md) · 🇹🇭 [ภาษาไทย](README.th.md) · 🇺🇿 [O'zbekcha](README.uz.md)

---

## Obsah

1. [Proč ProjectLens](#why-projectlens)
2. [V přehledu](#at-a-glance)
3. [Rychlý start](#quick-start)
4. [Jak to funguje](#how-it-works)
5. [Instalace podle nástroje (4 kanály)](#installation-by-tool)
6. [Adaptivní úrovně — T1 / T2 / T3](#adaptive-tiers)
7. [Pokrytí frameworků — 30 adaptérů v 8 balíčcích](#framework-coverage)
8. [Háčky relace — 5 produkčních háčků](#session-hooks)
9. [Kompaktor konverzace](#conversation-compactor)
10. [Ekonomika tokenů — konkrétní čísla](#token-economics)
11. [Testy a rozpočty výkonu](#tests--performance)
12. [Bezpečnost a správa](#security--governance)
13. [Konfigurační proměnné prostředí](#configuration)
14. [Struktura projektu](#project-structure)
15. [Rozšíření — napište vlastní adaptér](#extending-projectlens)
16. [Srovnání s alternativami](#comparison)
17. [FAQ](#faq)
18. [Plán](#roadmap)
19. [Přispívání a licence](#contributing--license)

---

## Proč ProjectLens

Moderní AI kódovací agenti mají problém s kontextovým oknem: čím větší projekt, tím více tokenů pálí jen na **orientaci**. Typický onboardingový tok přečte 20–40 souborů, než agent může dělat užitečnou práci — to je 10–30k tokenů utracených za pochopení, ne za řešení skutečného problému uživatele.

ProjectLens nahrazuje tuto fázi orientace **jediným skenováním** (pod 100 ms), které vytváří blok kontextu omezený tokeny a vědomý frameworků. Agent čte **jednu kapsli** místo desítek souborů. Využití tokenů klesá o 70–90% jen z úspor orientace.

**Kompromis:** deterministická strukturální extrakce (rychlá, zdarma, vědomá frameworků) místo sémantického vektorového vyhledávání. ProjectLens pracuje vedle sémantických nástrojů, ne proti nim.
...
📖 Úplné podrobné pokyny v **[`USER-INSTALL.md`](../../USER-INSTALL.md)**
---

## Jak to funguje

Skenovací engine spouští pět fází na vyvolání:
...
Typický runtime: **30 ms** u středně velkých projektů, **113 ms** u projektu s 500 soubory.

**Dva artefakty na skenování:**
...
## Instalace podle nástroje (4 kanály)

Čtyři distribuční kanály sdílejí stejný skenovací engine.

### Channel 1 — Claude Code / Cowork plugin (recommended)

Plný zážitek: všech 5 háčků se spouští, slash příkazy, statusline, memory loader.
...
Čistý stdlib JSON-RPC 2.0 stdio server. Pro samotný server není potřeba krok `pip install` — běží přímo z naklonovaného repa pomocí pouze standardní knihovny Python.
...
## Adaptivní úrovně — T1 / T2 / T3

ProjectLens automaticky vybírá správnou hloubku.
...
## Pokrytí frameworků — 30 adaptérů v 8 balíčcích

30 adaptérů v 8 balíčcích. Každý adaptér je ~80–120 LOC.
...
Jedno skenování ProjectLens v projektu vývoje AI odhaluje každý článek v řetězci.

---

## Háčky relace — 5 produkčních háčků

5 háčků se skládá v rámci relace Claude Code. Úspory tokenů se hromadí.
...
**Omezení Cowork:** v háčkové ploše Cowork se spouští pouze SessionStart.

---

## Kompaktor konverzace

Dlouhé relace pohlcují kontext. Kompaktor obnoví 8–25k tokenů za sekundy.
...
Kompaktor čte stav relace a generuje `WORKING_CONTEXT.md`:
...
Varování prázdného stavu: pokud se nespustily žádné háčky PostToolUse, kompaktor vydá jasnou diagnostiku.

---

## Ekonomika tokenů — konkrétní čísla

Odkud úspory pocházejí — konkrétní čísla:
...
**Příklad nákladů (ceny Opus, $15/Mtok vstup):** 4hodinová kódovací relace, která dříve stála ~$3, klesá na ~$0,45–$0,90.

---

## Testy a rozpočty výkonu

**527 unit testů** + **17 CI vynucovaných rozpočtů výkonu a bezpečnosti** běží při každém commitu.
...
**Nic není odesíláno mimo zařízení**, pokud explicitně nespustíte `/projectlens compact --llm`.

For governance — what contributions we accept and what we don't — see [`GOVERNANCE.md`](../../GOVERNANCE.md).

---

## Konfigurační proměnné prostředí
...
## Rozšíření — napište vlastní adaptér
...
ProjectLens je **lehká, deterministická orientační vrstva** v prostoru AI kódovacích asistentů.
...
O: Základní skenování funguje na JS, TS, Go, Java, Rust a ~20 dalších jazycích.
...
O: Ne, pokud explicitně nespustíte `/projectlens compact --llm` A nemáte nastaven `ANTHROPIC_API_KEY`.
...
**Q: Is it free?**
O: Ano — licence MIT. Bez předplatného, bez telemetrie.
...
Hlasujte na GitHub issues — co by mělo být první?
...
⭐ Označte toto repo hvězdou, pokud vám ProjectLens šetří tokeny.
