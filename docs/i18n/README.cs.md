...
15. [Rozšíření — napište vlastní adaptér](#extending-lensify)
...
Lensify nahrazuje tuto fázi orientace **jediným skenováním** (pod 100 ms), které vytváří blok kontextu omezený tokeny a vědomý frameworků. Agent čte **jednu kapsli** místo desítek souborů. Využití tokenů klesá o 70–90% jen z úspor orientace.

**Kompromis:** deterministická strukturální extrakce (rychlá, zdarma, vědomá frameworků) místo sémantického vektorového vyhledávání. Lensify pracuje vedle sémantických nástrojů, ne proti nim.
...
Lensify automaticky vybírá správnou hloubku.
...
Jedno skenování Lensify v projektu vývoje AI odhaluje každý článek v řetězci.
...
**Nic není odesíláno mimo zařízení**, pokud explicitně nespustíte `/lensify compact --llm`.
...
Lensify je **lehká, deterministická orientační vrstva** v prostoru AI kódovacích asistentů.
...
O: Ne, pokud explicitně nespustíte `/lensify compact --llm` A nemáte nastaven `ANTHROPIC_API_KEY`.
...
⭐ Označte toto repo hvězdou, pokud vám Lensify šetří tokeny.
