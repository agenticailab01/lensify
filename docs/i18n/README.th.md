...
> 🌐 **ภาษาไทย** — กลับไปยังภาษาอังกฤษ: [English](../../README.md)
...
> **เลนส์โปรเจ็กต์แบบสแกนครั้งเดียวที่ปรับตัวได้ + แคปซูลบริบทที่ปรับโทเคนสำหรับเอเจนต์การเขียนโค้ด AI** ลดโทเคนการปฐมนิเทศลง 70–90% ตระหนักถึงเฟรมเวิร์กตลอดวงจรชีวิตการพัฒนา AI ทั้งหมด ไลบรารีมาตรฐานบริสุทธิ์ ใบอนุญาต MIT

**📖 อ่านในภาษาของคุณ:** 🇬🇧 [← กลับไปยังภาษาอังกฤษ](../../README.md) · 🇨🇳 [简体中文](README.zh-CN.md) · 🇹🇼 [繁體中文](README.zh-TW.md) · 🇯🇵 [日本語](README.ja.md) · 🇰🇷 [한국어](README.ko.md) · 🇩🇪 [Deutsch](README.de.md) · 🇫🇷 [Français](README.fr.md) · 🇪🇸 [Español](README.es.md) · 🇮🇳 [हिन्दी](README.hi.md) · 🇧🇷 [Português](README.pt.md) · 🇷🇺 [Русский](README.ru.md) · 🇸🇦 [العربية](README.ar.md) · 🇮🇹 [Italiano](README.it.md) · 🇵🇱 [Polski](README.pl.md) · 🇳🇱 [Nederlands](README.nl.md) · 🇹🇷 [Türkçe](README.tr.md) · 🇺🇦 [Українська](README.uk.md) · 🇻🇳 [Tiếng Việt](README.vi.md) · 🇮🇩 [Bahasa Indonesia](README.id.md) · 🇸🇪 [Svenska](README.sv.md) · 🇬🇷 [Ελληνικά](README.el.md) · 🇷🇴 [Română](README.ro.md) · 🇨🇿 [Čeština](README.cs.md) · 🇫🇮 [Suomi](README.fi.md) · 🇩🇰 [Dansk](README.da.md) · 🇳🇴 [Norsk](README.no.md) · 🇭🇺 [Magyar](README.hu.md) · 🇺🇿 [O'zbekcha](README.uz.md)

---

## สารบัญ

1. [ทำไมต้อง ProjectLens](#why-projectlens)
2. [ภาพรวม](#at-a-glance)
3. [เริ่มต้นอย่างรวดเร็ว](#quick-start)
4. [วิธีการทำงาน](#how-it-works)
5. [การติดตั้งตามเครื่องมือ (4 ช่อง)](#installation-by-tool)
6. [ระดับการปรับตัว — T1 / T2 / T3](#adaptive-tiers)
7. [ความครอบคลุมเฟรมเวิร์ก — 30 อะแดปเตอร์ใน 8 แพ็ค](#framework-coverage)
8. [ฮุคเซสชัน — 5 ฮุคการผลิต](#session-hooks)
9. [ตัวบีบอัดการสนทนา](#conversation-compactor)
10. [เศรษฐศาสตร์โทเคน — ตัวเลขที่เป็นรูปธรรม](#token-economics)
11. [การทดสอบและงบประมาณประสิทธิภาพ](#tests--performance)
12. [ความปลอดภัยและการกำกับดูแล](#security--governance)
13. [ตัวแปรสภาพแวดล้อมการกำหนดค่า](#configuration)
14. [โครงสร้างโปรเจกต์](#project-structure)
15. [ขยาย — เขียนอะแดปเตอร์ของคุณเอง](#extending-projectlens)
16. [เปรียบเทียบกับทางเลือก](#comparison)
17. [คำถามที่พบบ่อย](#faq)
18. [แผนงาน](#roadmap)
19. [การมีส่วนร่วมและใบอนุญาต](#contributing--license)

---

## ทำไมต้อง ProjectLens

เอเจนต์การเขียนโค้ด AI สมัยใหม่มีปัญหาเรื่องหน้าต่างบริบท: ยิ่งโปรเจกต์ใหญ่เท่าใด พวกมันก็ยิ่งเผาผลาญโทเคนมากขึ้นเพียงเพื่อ**ปฐมนิเทศตัวเอง** โฟลว์การเริ่มต้นทั่วไปอ่าน 20-40 ไฟล์ก่อนที่เอเจนต์จะสามารถทำงานที่มีประโยชน์ได้ — นั่นคือ 10-30k โทเคนที่ใช้ในการทำความเข้าใจ ไม่ใช่การแก้ปัญหาจริงของผู้ใช้

ProjectLens แทนที่ระยะปฐมนิเทศนั้นด้วย**การสแกนครั้งเดียว** (ต่ำกว่า 100 มิลลิวินาที) ซึ่งสร้างบล็อกบริบทที่จำกัดโทเคนและตระหนักถึงเฟรมเวิร์ก เอเจนต์อ่าน**แคปซูลเดียว**แทนไฟล์หลายสิบไฟล์ การใช้โทเคนลดลง 70-90% เพียงจากการประหยัดการปฐมนิเทศ

**ข้อแลกเปลี่ยน:** การสกัดเชิงโครงสร้างแบบกำหนดได้แทนที่การค้นหาเวกเตอร์เชิงความหมาย ProjectLens ทำงานร่วมกับเครื่องมือเชิงความหมาย ไม่ขัดแย้ง
...
📖 คำแนะนำทีละขั้นตอนเต็มรูปแบบใน **[`USER-INSTALL.md`](../../USER-INSTALL.md)**
---

## วิธีการทำงาน

เครื่องยนต์สแกนทำงานห้าระยะต่อการเรียกใช้:
...
รันไทม์ทั่วไป: **30 มิลลิวินาที** บนโปรเจกต์ขนาดกลาง **113 มิลลิวินาที** บนโปรเจกต์ 500 ไฟล์

**สองอาร์ติแฟกต์ต่อการสแกน:**
...
## การติดตั้งตามเครื่องมือ (4 ช่อง)

ช่องทางการแจกจ่ายสี่ช่องใช้เครื่องยนต์สแกนเดียวกัน

### Channel 1 — Claude Code / Cowork plugin (recommended)

ประสบการณ์เต็ม: ฮุคทั้ง 5 ทำงาน, คำสั่ง slash, statusline, memory loader
...
เซิร์ฟเวอร์ JSON-RPC 2.0 stdio สเตดิบริสุทธิ์ ไม่ต้องการขั้นตอน `pip install` สำหรับเซิร์ฟเวอร์เอง — มันรันโดยตรงจากรีโปที่โคลนโดยใช้เฉพาะไลบรารีมาตรฐานของ Python
...
## ระดับการปรับตัว — T1 / T2 / T3

ProjectLens เลือกความลึกที่ถูกต้องโดยอัตโนมัติ
...
## ความครอบคลุมเฟรมเวิร์ก — 30 อะแดปเตอร์ใน 8 แพ็ค

30 อะแดปเตอร์ใน 8 แพ็ค แต่ละอะแดปเตอร์ ~80–120 LOC
...
การสแกน ProjectLens เดียวบนโปรเจกต์การพัฒนา AI จะเปิดเผยทุกข้อต่อในห่วงโซ่

---

## ฮุคเซสชัน — 5 ฮุคการผลิต

5 ฮุคประกอบกันในเซสชัน Claude Code การประหยัดโทเคนสะสม
...
**ข้อจำกัด Cowork:** มีเพียง SessionStart เท่านั้นที่ทำงานในพื้นผิวฮุคของ Cowork

---

## ตัวบีบอัดการสนทนา

เซสชันที่ยาวนานกินบริบท ตัวบีบอัดกู้คืน 8-25k โทเคนในไม่กี่วินาที
...
ตัวบีบอัดอ่านสถานะเซสชันและสร้าง `WORKING_CONTEXT.md`:
...
คำเตือนสถานะว่าง: หากไม่มีฮุค PostToolUse ทำงาน ตัวบีบอัดจะให้การวินิจฉัยที่ชัดเจน

---

## เศรษฐศาสตร์โทเคน — ตัวเลขที่เป็นรูปธรรม

การประหยัดมาจากไหน — ตัวเลขที่เป็นรูปธรรม:
...
**ตัวอย่างค่าใช้จ่าย (ราคา Opus, $15/Mtok input):** เซสชันการเขียนโค้ด 4 ชั่วโมงที่เคยมีค่าใช้จ่าย ~$3 ลดลงเหลือ ~$0.45–$0.90

---

## การทดสอบและงบประมาณประสิทธิภาพ

**527 unit tests** + **17 งบประมาณประสิทธิภาพและความปลอดภัยที่บังคับใช้โดย CI** ทำงานในทุก commit
...
**ไม่มีสิ่งใดถูกส่งออกนอกอุปกรณ์** เว้นแต่คุณจะรัน `/projectlens compact --llm` อย่างชัดเจน
...
ProjectLens คือ **เลเยอร์ปฐมนิเทศที่เบาและกำหนดได้** ในพื้นที่ผู้ช่วยการเขียนโค้ด AI
...
ต: การสแกนพื้นฐานใช้ได้กับ JS, TS, Go, Java, Rust และอีกประมาณ 20 ภาษาอื่น
...
ต: ไม่ เว้นแต่คุณจะรัน `/projectlens compact --llm` อย่างชัดเจน และตั้งค่า `ANTHROPIC_API_KEY`
...
**Q: Is it free?**
ต: ใช่ — ใบอนุญาต MIT ไม่มีการสมัครสมาชิก ไม่มีเทเลเมตรี
...
โหวตด้วย GitHub issues — สิ่งใดควรมาก่อน?

---

## การมีส่วนร่วมและใบอนุญาต
...
⭐ ติดดาวรีโปนี้ถ้า ProjectLens ช่วยประหยัดโทเคนให้คุณ
