...
1. [ทำไมต้อง Lensify](#why-lensify)
...
15. [ขยาย — เขียนอะแดปเตอร์ของคุณเอง](#extending-lensify)
...
Lensify แทนที่ระยะปฐมนิเทศนั้นด้วย**การสแกนครั้งเดียว** (ต่ำกว่า 100 มิลลิวินาที) ซึ่งสร้างบล็อกบริบทที่จำกัดโทเคนและตระหนักถึงเฟรมเวิร์ก เอเจนต์อ่าน**แคปซูลเดียว**แทนไฟล์หลายสิบไฟล์ การใช้โทเคนลดลง 70-90% เพียงจากการประหยัดการปฐมนิเทศ

**ข้อแลกเปลี่ยน:** การสกัดเชิงโครงสร้างแบบกำหนดได้แทนที่การค้นหาเวกเตอร์เชิงความหมาย Lensify ทำงานร่วมกับเครื่องมือเชิงความหมาย ไม่ขัดแย้ง
...
Lensify เลือกความลึกที่ถูกต้องโดยอัตโนมัติ
...
การสแกน Lensify เดียวบนโปรเจกต์การพัฒนา AI จะเปิดเผยทุกข้อต่อในห่วงโซ่
...
**ไม่มีสิ่งใดถูกส่งออกนอกอุปกรณ์** เว้นแต่คุณจะรัน `/lensify compact --llm` อย่างชัดเจน
...
Lensify คือ **เลเยอร์ปฐมนิเทศที่เบาและกำหนดได้** ในพื้นที่ผู้ช่วยการเขียนโค้ด AI
...
ต: ไม่ เว้นแต่คุณจะรัน `/lensify compact --llm` อย่างชัดเจน และตั้งค่า `ANTHROPIC_API_KEY`
...
⭐ ติดดาวรีโปนี้ถ้า Lensify ช่วยประหยัดโทเคนให้คุณ
