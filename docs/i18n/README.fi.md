...
> 🌐 **Suomi** — Takaisin englantiin: [English](../../README.md)
...
> **Yksiskannauksinen mukautuva projektilinssi + token-optimoitu kontekstikapseli AI-koodausagenteille.** Vähentää suuntaustokeneita 70–90 %. Framework-tietoinen koko AI-kehityksen elinkaaren ajan. Puhdas standardikirjasto. MIT-lisensoitu.

**📖 Lue kielelläsi:** 🇬🇧 [← Takaisin englantiin](../../README.md) · 🇨🇳 [简体中文](README.zh-CN.md) · 🇹🇼 [繁體中文](README.zh-TW.md) · 🇯🇵 [日本語](README.ja.md) · 🇰🇷 [한국어](README.ko.md) · 🇩🇪 [Deutsch](README.de.md) · 🇫🇷 [Français](README.fr.md) · 🇪🇸 [Español](README.es.md) · 🇮🇳 [हिन्दी](README.hi.md) · 🇧🇷 [Português](README.pt.md) · 🇷🇺 [Русский](README.ru.md) · 🇸🇦 [العربية](README.ar.md) · 🇮🇹 [Italiano](README.it.md) · 🇵🇱 [Polski](README.pl.md) · 🇳🇱 [Nederlands](README.nl.md) · 🇹🇷 [Türkçe](README.tr.md) · 🇺🇦 [Українська](README.uk.md) · 🇻🇳 [Tiếng Việt](README.vi.md) · 🇮🇩 [Bahasa Indonesia](README.id.md) · 🇸🇪 [Svenska](README.sv.md) · 🇬🇷 [Ελληνικά](README.el.md) · 🇷🇴 [Română](README.ro.md) · 🇨🇿 [Čeština](README.cs.md) · 🇩🇰 [Dansk](README.da.md) · 🇳🇴 [Norsk](README.no.md) · 🇭🇺 [Magyar](README.hu.md) · 🇹🇭 [ภาษาไทย](README.th.md) · 🇺🇿 [O'zbekcha](README.uz.md)

---

## Sisällysluettelo

1. [Miksi ProjectLens](#why-projectlens)
2. [Yhdellä silmäyksellä](#at-a-glance)
3. [Pika-aloitus](#quick-start)
4. [Miten se toimii](#how-it-works)
5. [Asennus työkalukohtaisesti (4 kanavaa)](#installation-by-tool)
6. [Mukautuvat tasot — T1 / T2 / T3](#adaptive-tiers)
7. [Frameworkien kattavuus — 30 adapteria 8 paketissa](#framework-coverage)
8. [Istunto-hookit — 5 tuotanto-hookia](#session-hooks)
9. [Keskustelutiivistäjä](#conversation-compactor)
10. [Token-talous — konkreettiset luvut](#token-economics)
11. [Testit ja suorituskykybudjetit](#tests--performance)
12. [Turvallisuus ja hallinta](#security--governance)
13. [Konfiguraatioympäristömuuttujat](#configuration)
14. [Projektin rakenne](#project-structure)
15. [Laajenna — kirjoita oma adapterisi](#extending-projectlens)
16. [Vertailu vaihtoehtoihin](#comparison)
17. [UKK](#faq)
18. [Etenemissuunnitelma](#roadmap)
19. [Osallistuminen ja lisenssi](#contributing--license)

---

## Miksi ProjectLens

Modernit AI-koodausagentit kärsivät kontekstiikkuna-ongelmasta: mitä suurempi projekti, sitä enemmän tokeneita ne polttavat vain **suunnistautumiseen**. Tyypillinen onboarding-virta lukee 20–40 tiedostoa ennen kuin agentti voi tehdä hyödyllistä työtä — se on 10–30k tokenia ymmärtämiseen, ei käyttäjän todellisen ongelman ratkaisemiseen.

ProjectLens korvaa tuon suunnistautumisvaiheen **yhdellä skannauksella** (alle 100 ms), joka tuottaa token-rajoitetun, framework-tietoisen konteksti-lohkon. Agentti lukee **yhden kapselin** kymmenien tiedostojen sijaan. Tokenien käyttö pienenee 70–90% jo pelkästään suunnistautumissäästöjen ansiosta.

**Kompromissi:** deterministinen rakenteellinen poiminta semanttisen vektorihaun sijaan. ProjectLens toimii semanttisten työkalujen rinnalla, ei niitä vastaan.
...
📖 Täydet vaiheittaiset ohjeet tiedostossa **[`USER-INSTALL.md`](../../USER-INSTALL.md)**
---

## Miten se toimii

Skannausmoottori suorittaa viisi vaihetta kutsua kohti:
...
Tyypillinen ajoaika: **30 ms** keskikokoisilla projekteilla, **113 ms** 500-tiedostoisella projektilla.

**Kaksi tuotosta per skannaus:**
...
## Asennus työkalukohtaisesti (4 kanavaa)

Neljä jakelukanavaa jakavat saman skannausmoottorin.

### Channel 1 — Claude Code / Cowork plugin (recommended)

Täysi kokemus: kaikki 5 hookkia laukeavat, slash-komennot, statusline, memory loader.
...
Puhdas stdlib JSON-RPC 2.0 stdio -palvelin. Itse palvelimelle ei tarvita `pip install`-vaihetta — se toimii suoraan kloonatusta repostosta käyttäen vain Pythonin standardikirjastoa.
...
## Mukautuvat tasot — T1 / T2 / T3

ProjectLens valitsee oikean syvyyden automaattisesti.
...
## Frameworkien kattavuus — 30 adapteria 8 paketissa

30 adapteria 8 paketissa. Jokainen adapteri on ~80–120 LOC.
...
Yksi ProjectLens-skannaus AI-kehitysprojektissa tuo esiin ketjun jokaisen linkin.

---

## Istunto-hookit — 5 tuotanto-hookia

5 hookkia yhdistyvät Claude Code -istunnossa. Tokensäästöt kumuloituvat.
...
**Cowork-rajoitus:** vain SessionStart laukeaa Coworkin hook-pinnalla.

---

## Keskustelutiivistäjä

Pitkät istunnot syövät kontekstia. Kompaktori palauttaa 8–25k tokenia sekunneissa.
...
Kompaktori lukee istuntotilan ja luo `WORKING_CONTEXT.md`-tiedoston, joka tiivistää:
...
Tyhjän tilan varoitus: jos PostToolUse-hookkeja ei lauennut, kompaktori antaa selkeän diagnoosin.

---

## Token-talous — konkreettiset luvut

Mistä säästöt tulevat — konkreettiset luvut:
...
**Kustannusesimerkki (Opus-hinta, $15/Mtok input):** 4-tunnin koodausistunto, joka aiemmin maksoi ~$3, putoaa ~$0,45–$0,90:een.

---

## Testit ja suorituskykybudjetit

**527 yksikkötestiä** + **17 CI:n pakottamaa suorituskyky- ja turvallisuusbudjettia** ajetaan jokaisella commitilla.
...
**Mitään ei lähetetä laitteen ulkopuolelle**, ellet nimenomaisesti aja `/projectlens compact --llm`.

For governance — what contributions we accept and what we don't — see [`GOVERNANCE.md`](../../GOVERNANCE.md).

---

## Konfiguraatioympäristömuuttujat
...
## Laajenna — kirjoita oma adapterisi
...
ProjectLens on **kevyt, deterministinen suunnistautumiskerros** AI-koodausassistenttiavaruudessa.
...
V: Peruskannus toimii JS:llä, TS:llä, Go:lla, Java:lla, Rustilla ja ~20 muulla kielellä.
...
V: Ei, ellet nimenomaisesti aja `/projectlens compact --llm` JA ole asettanut `ANTHROPIC_API_KEY`:ta.
...
**Q: Is it free?**
V: Kyllä — MIT-lisensoitu. Ei tilausta, ei telemetriaa.
...
Äänestä GitHub-issueilla — mikä tulisi ensin?
...
⭐ Anna tähti tälle repolle, jos ProjectLens säästää sinulta tokeneita.
