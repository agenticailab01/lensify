...
These translated READMEs are condensed quick-starts. For the full documentation (`CONTRIBUTING.md`, `SECURITY.md`, `GOVERNANCE.md`, `BENCHMARK.md`, integration recipes, and the adapter SDK) the source-of-truth language is English. Translations of those deeper docs are welcomed as community contributions — see `CONTRIBUTING.md` for the process.
