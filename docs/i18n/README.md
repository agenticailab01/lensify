...
For the full English documentation (CONTRIBUTING, SECURITY, GOVERNANCE, BENCHMARK, etc.), see the root of the repo. Translations of those deeper docs are welcomed as community contributions — see `CONTRIBUTING.md`.
