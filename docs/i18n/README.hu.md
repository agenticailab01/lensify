...
> 🌐 **Magyar** — Vissza az angolhoz: [English](../../README.md)
...
> **Egyszeri pásztázású adaptív projektlencse + token-optimalizált kontextus kapszula AI kódoló ágensekhez.** Csökkenti a tájékozódási tokeneket 70–90%-kal. Keretrendszer-tudatos a teljes AI fejlesztési életciklus során. Tiszta standard könyvtár. MIT licenc.

**📖 Olvasd a saját nyelveden:** 🇬🇧 [← Vissza az angolhoz](../../README.md) · 🇨🇳 [简体中文](README.zh-CN.md) · 🇹🇼 [繁體中文](README.zh-TW.md) · 🇯🇵 [日本語](README.ja.md) · 🇰🇷 [한국어](README.ko.md) · 🇩🇪 [Deutsch](README.de.md) · 🇫🇷 [Français](README.fr.md) · 🇪🇸 [Español](README.es.md) · 🇮🇳 [हिन्दी](README.hi.md) · 🇧🇷 [Português](README.pt.md) · 🇷🇺 [Русский](README.ru.md) · 🇸🇦 [العربية](README.ar.md) · 🇮🇹 [Italiano](README.it.md) · 🇵🇱 [Polski](README.pl.md) · 🇳🇱 [Nederlands](README.nl.md) · 🇹🇷 [Türkçe](README.tr.md) · 🇺🇦 [Українська](README.uk.md) · 🇻🇳 [Tiếng Việt](README.vi.md) · 🇮🇩 [Bahasa Indonesia](README.id.md) · 🇸🇪 [Svenska](README.sv.md) · 🇬🇷 [Ελληνικά](README.el.md) · 🇷🇴 [Română](README.ro.md) · 🇨🇿 [Čeština](README.cs.md) · 🇫🇮 [Suomi](README.fi.md) · 🇩🇰 [Dansk](README.da.md) · 🇳🇴 [Norsk](README.no.md) · 🇹🇭 [ภาษาไทย](README.th.md) · 🇺🇿 [O'zbekcha](README.uz.md)

---

## Tartalomjegyzék

1. [Miért ProjectLens](#why-projectlens)
2. [Egy pillantásra](#at-a-glance)
3. [Gyorskezdés](#quick-start)
4. [Hogyan működik](#how-it-works)
5. [Telepítés eszköz szerint (4 csatorna)](#installation-by-tool)
6. [Adaptív szintek — T1 / T2 / T3](#adaptive-tiers)
7. [Keretrendszer-lefedettség — 30 adapter 8 csomagban](#framework-coverage)
8. [Munkamenet-horgok — 5 termelési horog](#session-hooks)
9. [Beszélgetés-tömörítő](#conversation-compactor)
10. [Token-gazdaságtan — konkrét számok](#token-economics)
11. [Tesztek és teljesítmény-költségvetések](#tests--performance)
12. [Biztonság és kormányzás](#security--governance)
13. [Konfigurációs környezeti változók](#configuration)
14. [Projektstruktúra](#project-structure)
15. [Bővítés — írd meg saját adaptered](#extending-projectlens)
16. [Összehasonlítás alternatívákkal](#comparison)
17. [GYIK](#faq)
18. [Útiterv](#roadmap)
19. [Hozzájárulás és licenc](#contributing--license)

---

## Miért ProjectLens

A modern AI kódoló ágensek kontextusablak-problémával küzdenek: minél nagyobb a projekt, annál több tokent égetnek el csak az **eligazódásra**. Egy tipikus onboarding folyamat 20-40 fájlt olvas el, mielőtt az ágens hasznos munkát végezhetne — ez 10-30k token elköltése a megértésre, nem pedig a felhasználó valódi problémájának megoldására.

A ProjectLens helyettesíti ezt az eligazódási fázist egy **egyszeri pásztázással** (100 ms alatt), amely token-korlátos, keretrendszer-tudatos kontextusblokkot hoz létre. Az ágens **egyetlen kapszulát** olvas tucatnyi fájl helyett. A tokenhasználat 70-90%-kal csökken csak az eligazódási megtakarításokból.

**A kompromisszum:** determinisztikus strukturális kinyerés szemantikus vektorkeresés helyett. A ProjectLens a szemantikus eszközök mellett dolgozik, nem ellenük.
...
📖 Teljes lépésről lépésre útmutató itt: **[`USER-INSTALL.md`](../../USER-INSTALL.md)**
---

## Hogyan működik

A pásztázó motor öt fázist futtat le hívásonként:
...
Tipikus futási idő: **30 ms** közepes projekteken, **113 ms** egy 500-fájlos projekten.

**Két termék pásztázásonként:**
...
## Telepítés eszköz szerint (4 csatorna)

Négy terjesztési csatorna osztozik ugyanazon a pásztázó motoron.

### Channel 1 — Claude Code / Cowork plugin (recommended)

A teljes élmény: mind az 5 horog elsül, slash parancsok, statusline, memory loader.
...
Tiszta stdlib JSON-RPC 2.0 stdio szerver. Magához a szerverhez nem szükséges `pip install` lépés — közvetlenül a klónozott repóból fut, csak a Python standard könyvtárat használva.
...
## Adaptív szintek — T1 / T2 / T3

A ProjectLens automatikusan választja ki a megfelelő mélységet.
...
## Keretrendszer-lefedettség — 30 adapter 8 csomagban

30 adapter 8 csomagon át. Minden adapter ~80-120 LOC.
...
Egyetlen ProjectLens pásztázás egy AI-fejlesztési projekten kihozza a lánc minden szemét.

---

## Munkamenet-horgok — 5 termelési horog

5 horog összeáll egy Claude Code munkamenetben. A tokenmegtakarítások halmozódnak.
...
**Cowork-korlátozás:** csak a SessionStart sül el a Cowork horog-felületén.

---

## Beszélgetés-tömörítő

A hosszú munkamenetek felemésztik a kontextust. A tömörítő másodpercek alatt 8-25k tokent nyer vissza.
...
A tömörítő olvassa a munkamenet-állapotot és generál egy `WORKING_CONTEXT.md`-t:
...
Üres állapot figyelmeztetés: ha nem sült el PostToolUse horog, a tömörítő világos diagnózist ad ki.

---

## Token-gazdaságtan — konkrét számok

Honnan jönnek a megtakarítások — konkrét számok:
...
**Költségpélda (Opus árazás, $15/Mtok input):** egy 4 órás kódolási munkamenet, amely korábban ~$3-ba került, ~$0,45–$0,90-ra esik.

---

## Tesztek és teljesítmény-költségvetések

**527 egységteszt** + **17 CI által érvényesített teljesítmény- és biztonsági költségvetés** fut minden commitnál.
...
**Semmi sem kerül elküldésre az eszközön kívülre**, hacsak nem futtatod kifejezetten a `/projectlens compact --llm`-et.

For governance — what contributions we accept and what we don't — see [`GOVERNANCE.md`](../../GOVERNANCE.md).

---

## Konfigurációs környezeti változók
...
## Bővítés — írd meg saját adaptered
...
A ProjectLens **a könnyű, determinisztikus eligazítási réteg** az AI kódolóasszisztens-térben.
...
V: Az alappásztázás JS-en, TS-en, Go-n, Java-n, Rust-on és ~20 más nyelven működik.
...
V: Nem, hacsak nem futtatod kifejezetten a `/projectlens compact --llm`-et ÉS van beállítva `ANTHROPIC_API_KEY`.
...
**Q: Is it free?**
V: Igen — MIT licenc. Nincs előfizetés, nincs telemetria.
...
Szavazz GitHub issue-kkal — mi jöjjön először?
...
⭐ Csillagozd be ezt a repót, ha a ProjectLens tokent takarít meg neked.
