...
15. [Udvid — skriv din egen adapter](#extending-lensify)
...
Lensify erstatter denne orienteringsfase med en **enkelt scanning** (under 100 ms), der producerer en token-begrænset, framework-bevidst kontekstblok. Agenten læser **én kapsel** i stedet for dusinvis af filer. Tokenforbrug falder 70-90% alene fra orienteringsbesparelser.

**Kompromiset:** deterministisk strukturel udtræk i stedet for semantisk vektorsøgning. Lensify arbejder sammen med semantiske værktøjer, ikke imod dem.
...
Lensify vælger automatisk den rigtige dybde.
...
En enkelt Lensify-scanning på et AI-udviklingsprojekt afslører hvert led i kæden.
...
**Intet sendes off-device**, medmindre du eksplicit kører `/lensify compact --llm`.
...
Lensify er **det lette, deterministiske orienteringslag** i AI-kodningsassistentrummet.
...
S: Nej, medmindre du eksplicit kører `/lensify compact --llm` OG har `ANTHROPIC_API_KEY` sat.
...
⭐ Stjernemarker dette repo, hvis Lensify sparer dig tokens.
